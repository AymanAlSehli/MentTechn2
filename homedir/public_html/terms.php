<?php include 'header.php'; 
    $officielpage = $DB_con->prepare("SELECT e_terms FROM `officielpage`");
    ...
    <div class='rgt col-md-7'>
        <div class="row">
            <div class="panel panel-default" style='margin-right:10px;border-radius:0px;'>
              <div class="panel-heading" style='font-size:17px;background:#2c3e50;border-radius:0px;color:white;border-color:#2c3e50;'><span class="lft glyphicon glyphicon-question-sign"></span>  سياسة الخصوصية </div>
