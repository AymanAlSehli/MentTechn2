<?php include 'header.php'; 
    $officielpage = $DB_con->prepare("SELECT e_aboutus FROM `officielpage`");
    ...
    <div class='rgt col-md-7'>
        <div class="row">
            <div class="panel panel-default" style='margin-right:10px;border-radius:0px;'>
              <div class="panel-heading" style='font-size:17px;background:#2c3e50;border-radius:0px;color:white;border-color:#2c3e50;'><span class="lft glyphicon glyphicon-question-sign"></span>  معلومات عن الموقع   </div>
              <div class="panel-body" style='line-height:25px;font-size:16px;margin:10px;'>
                <div class="alert alert-info" style='border-radius:0px;'>
                    جميع معلومات الموقع تجدها في هذا الصفحة 
                </div>
                <div class='clr'></div>
                <?php echo "".$OP->e_aboutus.""; ?> 
              </div>
            </div>
        </div>
     </div>
