...
<html>
  <head>
    ...
    <meta property="og:url"           content="http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>" />
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="<?php echo"".$getp->title.""; ?>" />
    <meta property="og:description"   content="<?php echo"".$getp->title.""; ?>" />
    <meta property="og:image"         content="http://www.menttech.net/imgupload/<?php echo"".$getp->image.""; ?>" />         
...
<div class="row">
    <div class='clr'></div>
     ...
     <div class='rgt col-md-10'>
        <div class="row">
          <div class="col-sm-10" style='background:white;margin-right:20px;width:auto;'>
            ...
            <img class='fade2 imgreview' src="imagespost/<?php echo ''.$getp->image.''; ?>">
            <div class='reviewWid'>
            <div style="reviewTopic">
                <div class='clr'></div>
                <p class="reviewfont"><?php echo ''.$getp->title.''; ?></p> 

            </div>    
            </div> 
            <div style='background:white;height:auto;'>
            <div style="padding:10px;">
                <span class='rgt'>فبراير 2 - 2016</span>
                <div class='clr'></div>
                <div class='estoimg'>
                 <?php echo ''.$getp->content.''; ?>
                </div>
            </div>                
            </div>
            <div class='clr'></div>
            ...
            display: inline;
             ...
             <center><div id="share-buttons">
                ...
                <!-- Facebook -->
                <a href="http://www.facebook.com/sharer.php?u=http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>" target="_blank">
                    <img src="https://simplesharebuttons.com/images/somacro/facebook.png" alt="Facebook" />
                </a>

                <!-- Google+ -->
                <a href="https://plus.google.com/share?url=http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>" target="_blank">
                    <img src="https://simplesharebuttons.com/images/somacro/google.png" alt="Google" />
                </a>

                <!-- LinkedIn -->
                 <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>" target="_blank">
                ...
                <!-- Tumblr-->
                <a href="http://www.tumblr.com/share/link?url=http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>&amp;title=<?php echo"".$getp->title.""; ?>" target="_blank">
                    <img src="https://simplesharebuttons.com/images/somacro/tumblr.png" alt="Tumblr" />
                </a>


                <!-- Twitter -->
                <a href="https://twitter.com/share?url=http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>&amp;text=<?php echo"".$getp->title.""; ?>" target="_blank">
                    <img src="https://simplesharebuttons.com/images/somacro/twitter.png" alt="Twitter" />
                </a>

                <!-- VK -->
                <a href="http://vkontakte.ru/share.php?url=http://www.menttech.net/post.php?id=<?php echo"".$getp->id.""; ?>" target="_blank">
            ...
            <hr/>  
            <div class='clr'></div>   
            <div class="col-sm-12 reviewlikeWid">
             <table class="table table-bordered reviewlike">
                <tbody>
                ...
                <div class='clr'></div>              
                  ...
                  <div class='clr'></div>
                  <div class='blike2'>
                    <p class='blike3'> <span class="glyphicon glyphicon-thumbs-up"></span> قد تعجبك  </p> 
                  </div>
                <div class='clr'></div>
                    <div class='rigt'>
                    <?php 
                ...
                <div style='background:#f2f2f2;margin-top:20px;height:35px;border-bottom:3px solid #9B59B6;'>
                <p style='text-align:center;background:#9B59B6;width:150px;height:35px;color:white;padding:7px;'> <span class="glyphicon glyphicon-comment"></span> تعليقات   </p> 
                </div>   
                <div class='clr'></div>
                <!-- Commetn  !-->
