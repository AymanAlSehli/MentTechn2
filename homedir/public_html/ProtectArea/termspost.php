<?php include "header.php"; include "session.php";
        ...
        if(isset($_POST['UpdateSetting'])){
           ...
           $ep  = $_POST['e_post'];
            ...
            $UPD->bindParam(':e_post', $ep, PDO::PARAM_STR);       
            $UPD->execute(); 

           echo"<div class='alert alert-block alert-success'>ثم تعديل البيانات بنجاح </div>";
           echo'<meta http-equiv="refresh" content="3; url=termspost.php" />';	   
...
?>
<div class='TitleTag'>سياسة النقل </div>
      ...
      <form class='rgt' action='' method='post' style='margin:10px;padding:10px;text-align:right;font-size:14px;'>
        ...
        <div class='rgt form-group' style='margin-right:5px;'>
            <label for='inputPassword'> سياسة النقل  </label>
            <textarea name='e_post' id='mytextarea' class='form-control' style='width:950px;text-align:right;height:360px;border-radius:0px;'><?php echo"".$infos->e_post.""; ?></textarea>
