        ...
        if(isset($_POST['Add'])){
          ...
          if($newPage['title'] == ''){
           echo"<div class='alert alert-block alert-danger'>Title not found</div>";
            ...
            echo'<meta http-equiv="refresh" content="3; url=newreview.php" />';	
            }
            }catch (Exception $exc){
              echo $exc->getMessage();
            }
          ...
          <div class='clr'></div>          
           ...
           <div class='clr'></div>
            <div class='rgt form-group' style='margin-right:5px;'>
                    ...
                    <input type='text' name='videolink' class='form-control' style='width:400px;height:40px;border-radius:0px;'>
            </div>           
           <div class='clr'></div>
