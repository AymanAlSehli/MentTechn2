<?php include "header.php"; include "session.php"; 
        ...
        if(isset($_POST['UpdateSetting'])){
           ...
           $ep  = $_POST['e_aboutus'];
            ...
            $UPD->bindParam(':e_aboutus', $ep, PDO::PARAM_STR);       
            $UPD->execute(); 
...
?>
<div class='TitleTag'>صفحة من نحن !</div>
      ...
      <form class='rgt' action='' method='post' style='margin:10px;padding:10px;text-align:right;font-size:14px;'>
        ...
        <div class='rgt form-group' style='margin-right:5px;'>
            <label for='inputPassword'> صفحة من نحن ! </label>
            <textarea name='e_aboutus' id='mytextarea' class='form-control' style='width:950px;text-align:right;height:360px;border-radius:0px;'><?php echo"".$infos->e_aboutus.""; ?></textarea>
